...
load:function(e){
if(!e||e.length<=0)return seajs.combo_status=seajs.COMBO_LOADED,seajs.run(),void console.debug("[moon] load js complete, all in cache, cost time : 0ms, total count : "+l.mod_num+", hit num: "+l.hit_num);
...
if(t++,t==e.length){
var n=+new Date-o;
seajs.combo_status=seajs.COMBO_LOADED,seajs.run(),console.debug("[moon] load js complete, url num : "+e.length+", total mod count : "+l.mod_num+", hit num: "+l.hit_num+", use time : "+n+"ms");
}
});
});
},

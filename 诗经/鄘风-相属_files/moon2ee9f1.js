...
},a.moon_lid=E,j[E]=o,E++,e.call(i,t,o,n);
};
}
function c(e){
return function(t,o,n){
if("undefined"==typeof n)var n=!1;
var r=this;
return o=j[o.moon_lid],e.call(r,t,o,n);
};
}
...
/\/s?/.test(location.href))){
var y=new Image,O="https://badjs.weixinbridge.com/badjs?id=43&level=4&from="+encodeURIComponent(location.href)+"&msg="+r;
y.src=O.slice(0,1024);
}
}
...
var b=window.localStorage.setItem,I=0;
